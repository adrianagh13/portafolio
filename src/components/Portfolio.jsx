    ...
    <section id="portafolio" className="portfolio">
        <div className="wrapper">
            ...
            <article className="project">
                ...
                <figure className="project-imageContainer">
                    <img className="project-image" src={video} alt="video" width="500" height="300" />
                </figure>
            </article>
            <article className="project">
                <div className="project-details"> 
            ...
            <article className="project">
                <div className="project-details"> 
                    ...
                    <p className="project-url"><strong>Chécala en: </strong>https://adrianagh13.github.io/Pokemon/</p>
                    <p className="project-description">Se trata de una plataforma de reproducción de videos que te permite registarte como usuario y crear tus propias listas de videos favoritos.<br />Desarrollada con HTML, CSS, Bootstrap y React.</p>
                </div>
                <figure className="project-imageContainer">
                    <img className="project-image"src={video} alt="video" width="500" height="300" />
                </figure>
